...
- **model1/**, **model2/**: Stores various model parameters. Among them, ml0-ml4 are the results of 5-fold cross-validation; the file *ml_pu* contains the model parameters after training with PU learning integrated. The difference between *\*_loss* and *\*_mcc* files is that the saved training results use loss value or MCC value as the criterion for evaluating model performance, respectively.
